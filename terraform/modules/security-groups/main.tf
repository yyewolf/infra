...
// all udp
resource "openstack_networking_secgroup_rule_v2" "all_udp_controller" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "udp"
...
// all tcp
resource "openstack_networking_secgroup_rule_v2" "all_tcp_controller" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "tcp"
...
// all udp
resource "openstack_networking_secgroup_rule_v2" "all_udp_worker" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "udp"
...
// all tcp
resource "openstack_networking_secgroup_rule_v2" "all_tcp_worker" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "tcp"
